...
from entropy_benchmarking.circuits_1d_util import (
...
def gate_path_hybrid(num_qubits: int,
                     num_iterations: int, ###! note that this is based on counting the number of proposed Trotter iterations
    ...
    for ith_iteration in range(num_iterations): ###! note that this is based on counting the number of proposed Trotter iterations
    ...
    for ith_iteration in range(num_iterations):
        ...
        for ith_qubit in range(0, num_qubits - 2, 4): ### encoder for blue H_eff ### 0 mod 4
            qc.compose(gate_block_trotter_triangle_1d(dt=dt,
                        ...
                        inplace=True,)
        ###
        for ith_qubit in range(1, num_qubits - 2, 4): ### encoder for blue H_eff ### 1 mod 4
            qc.compose(gate_block_trotter_triangle_1d(dt=dt,
                                                    type_H_eff=type_H_eff,
                                                    type_enc_dec="H", ###!
                                                    connectivity=connectivity,
                        ...
                        inplace=True,)
        ###
        for ith_qubit in range(3, num_qubits - 2, 4): ### encoder for blue H_eff ### 3 mod 4
            qc.compose(gate_block_trotter_triangle_1d(dt=dt,
                                                    type_H_eff=type_H_eff,
                                                    connectivity=connectivity,
                                                    to_instruction=to_instruction,
